...
#
# Created: Thu Jun 04 15:18:56 2009
...
class Ui_sIBL_GUI_FTP_Form( object ):
	def setupUi( self, sIBL_GUI_FTP_Form ):
		...
		self.Start_Download_pushButton = QtGui.QPushButton( self.Buttons_groupBox )
		self.Start_Download_pushButton.setObjectName( "Start_Download_pushButton" )
		self.Buttons_gridLayout.addWidget( self.Start_Download_pushButton, 0, 0, 1, 1 )
		self.Cancel_pushButton = QtGui.QPushButton( self.Buttons_groupBox )
		self.Cancel_pushButton.setObjectName( "Cancel_pushButton" )
		self.Buttons_gridLayout.addWidget( self.Cancel_pushButton, 0, 1, 1, 1 )
	...
	def retranslateUi( self, sIBL_GUI_FTP_Form ):
		...
		self.Start_Download_pushButton.setText( QtGui.QApplication.translate( "sIBL_GUI_FTP_Form", "Start Download", None, QtGui.QApplication.UnicodeUTF8 ) )
